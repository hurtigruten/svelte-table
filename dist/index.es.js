...
const get_expanded_slot_changes = dirty => ({
	...
	handleClick: dirty[0] & /*filteredRows*/ 512,
	row: dirty[0] & /*filteredRows*/ 512
});
...
const get_cell_slot_changes = dirty => ({
	...
	handleExpand: dirty[0] & /*filteredRows*/ 512,
	cell: dirty[0] & /*filteredRows, columns*/ 576,
...
const get_head_slot_changes = dirty => ({
	column: dirty[0] & /*columns*/ 64,
	isColumnHovered: dirty[0] & /*hoverColumn*/ 8192,
	isSorted: dirty[0] & /*lastSortedKey, columns*/ 2112,
...
const get_head_slot_context = ctx => ({
	...
	isSorted: /*lastSortedKey*/ ctx[11] === /*column*/ ctx[45].key,
...
function create_if_block_4(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (head_slot) {
				if (head_slot.p && (!current || dirty[0] & /*$$scope, columns, hoverColumn, lastSortedKey, sortDescending, isSortable*/ 134232256)) {
					update_slot_base(
						head_slot,
						head_slot_template,
						ctx,
...
function create_else_block_1(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty[0] & /*filteredRows, columns*/ 576 && t_value !== (t_value = /*row*/ ctx[40][/*column*/ ctx[45].key] + "")) set_data(t, t_value);
		},
		i: noop,
		o: noop,
		d(detaching) {
...
function create_if_block_3(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (cell_slot) {
				if (cell_slot.p && (!current || dirty[0] & /*$$scope, filteredRows, columns, hoverRow, hoverColumn*/ 134242880)) {
					update_slot_base(
						cell_slot,
						cell_slot_template,
						ctx,
...
function create_if_block_2(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (expanded_slot) {
				if (expanded_slot.p && (!current || dirty[0] & /*$$scope, assignedClasses, filteredRows*/ 134251008)) {
					update_slot_base(
						expanded_slot,
...
function create_each_block(ctx) {
	...
	return {
		...
		p(new_ctx, dirty) {
			...
			if (dirty[0] & /*assignedClasses, dispatch, columns, filteredRows, setHovered, $$scope, hoverRow, hoverColumn, $$slots*/ 155312704) {
			...
			if (!current || dirty[0] & /*assignedClasses, filteredRows*/ 33280 && tr_class_value !== (tr_class_value = "" + (null_to_empty(`${/*assignedClasses*/ ctx[15].tr} ${/*isExpanded*/ ctx[41]} ${/*isEvenOrOdd*/ ctx[42]}`) + " svelte-u2gknh"))) {
...
function create_else_block(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty[0] & /*enabled*/ 1024) pagination_changes.enabled = /*enabled*/ ctx[10];
...
function create_if_block_1(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (pagination_slot) {
				if (pagination_slot.p && (!current || dirty[0] & /*$$scope, rows, enabled, totalPages, currentPage, totalItems, from, to*/ 134218815)) {
					update_slot_base(
						pagination_slot,
...
function create_fragment(ctx) {
	...
	let each_value = /*filteredRows*/ ctx[9];
	let each_blocks = [];
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty[0] & /*assignedClasses, dispatch, columns, sortRowsBy, setHovered, $$scope, hoverColumn, lastSortedKey, sortDescending, isSortable, $$slots*/ 163690688) {
			...
			if (dirty[0] & /*$$scope, assignedClasses, dispatch, filteredRows, columns, setHovered, hoverRow, hoverColumn, $$slots*/ 155312704) {
				each_value = /*filteredRows*/ ctx[9];
				let i;
...
function instance($$self, $$props, $$invalidate) {
	...
	const updateFromToValues = () => {
		...
		$$invalidate(10, enabled.nextPage = currentPage < totalPages, enabled);
		$$invalidate(10, enabled.prevPage = currentPage > 1, enabled);
		$$invalidate(10, enabled.firstPage = currentPage > 1, enabled);
		$$invalidate(10, enabled.lastPage = currentPage < totalPages, enabled);
	};
	...
	const sortRowsBy = key => {
		...
		if (lastSortedKey === key) {
			$$invalidate(12, sortDescending = !sortDescending);
		} else {
			$$invalidate(12, sortDescending = false);
		}

		$$invalidate(11, lastSortedKey = key);
	...
	const slicePaginated = () => {
		$$invalidate(9, filteredRows = asyncPagination ? [...rows] : rows.slice(from - 1, to));
	};
	...
	const func = (row, each_value, rowIndex) => $$invalidate(9, each_value[rowIndex].isExpanded = row.isExpanded ? !row.isExpanded : true, filteredRows);
	...
	$$self.$$.update = () => {
		...
		if ($$self.$$.dirty[0] & /*rows, filteredRows, currentPage, rowsPerPage*/ 771) {
