  ...
  return {
    c() {
      ...
      attr(
        path0,
        'd',
        'M8.26186 13.7732C8.11155 13.9034 7.88845 13.9034 7.73814 13.7732L4.4809 10.9524C4.20094 10.7099 4.37241 10.25 4.74276 10.25L11.2572 10.25C11.6276 10.25 11.7991 10.7099 11.5191 10.9524L8.26186 13.7732Z'
      );
      attr(
        path0,
        'fill',
        (path0_fill_value = /*sortOrder*/ ctx[0] === 1 ? '#1D4ED8' : '#B0AEAC')
      );
      attr(
        path1,
        'd',
        'M7.73814 2.22678C7.88845 2.09661 8.11155 2.09661 8.26186 2.22678L11.5191 5.04763C11.7991 5.29008 11.6276 5.75 11.2572 5.75H4.74276C4.37241 5.75 4.20094 5.29008 4.4809 5.04763L7.73814 2.22678Z'
      );
      attr(
        path1,
        'fill',
        (path1_fill_value = /*sortOrder*/ ctx[0] === -1 ? '#1D4ED8' : '#B0AEAC')
      );
      attr(svg, 'width', '16');
      attr(svg, 'height', '16');
    ...
    p(ctx, [dirty]) {
      if (
        ...
        path0_fill_value !==
          (path0_fill_value =
            /*sortOrder*/ ctx[0] === 1 ? '#1D4ED8' : '#B0AEAC')
      ) {
...
function instance$1($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$props) => {
    if ('sortOrder' in $$props)
      $$invalidate(0, (sortOrder = $$props.sortOrder));
  };
  ...
  return {
    ...
    p(ctx, dirty) {
      ...
      if (dirty & /*sortOrder*/ 2)
        iconsorting_changes.sortOrder = /*sortOrder*/ ctx[1];
...
function create_each_block_3(ctx) {
  ...
  function select_block_type(ctx, dirty) {
    if (/*col*/ ctx[25].titleComponent) return 0;
    return 1;
  }
  ...
  if_block0 = if_blocks[current_block_type_index] =
    if_block_creators[current_block_type_index](ctx);
  let if_block1 = /*col*/ ctx[25].sortable && create_if_block_4(ctx);
  let if_block2 = /*col*/ ctx[25].helpModal && create_if_block_3(ctx);
  ...
  return {
    c() {
      ...
      attr(
        th,
        'class',
        (th_class_value = `cursor-pointer ${/*styles*/ ctx[3].th} ${
          /*col*/ ctx[25].headerClass
        }`)
      );
    ...
    m(target, anchor) {
      ...
      if (!mounted) {
        dispose = listen(th, 'click', function () {
          if (
            is_function(/*col*/ ctx[25].sortable ? click_handler_1 : undefined)
          )
            /*col*/ (ctx[25].sortable ? click_handler_1 : undefined).apply(
              this,
              arguments
            );
        });
    ...
    p(new_ctx, dirty) {
      ...
      if (dirty & /*styles, columns, columns*/ 12) {
        toggle_class(
          th,
          'pr-4',
          /*columns*/ ctx[2].length - 1 === /*i*/ ctx[29]
        );
      }
    },
    i(local) {
...
function fallback_block_1(ctx) {
  ...
  return {
    ...
    p(ctx, dirty) {
      if (
        dirty &
        /*styles, columns, handleClickCol, undefined, activeModal, sortOrder, sortBy*/ 159
      ) {
...
function create_if_block(ctx) {
  ...
  return {
    ...
    p(ctx, dirty) {
      if (
        dirty &
        /*columns, sortedRows, styles, handleClickRow, handleClickCell, $$scope*/ 2860
      ) {
...
function create_else_block(ctx) {
  ...
  return {
    ...
    p(ctx, dirty) {
      ...
      if (
        dirty & /*styles*/ 8 &&
        div_class_value !== (div_class_value = /*styles*/ ctx[3].cell)
      ) {
...
function create_if_block_2(ctx) {
  ...
  var switch_value =
    /*col*/ ctx[25].component.component || /*col*/ ctx[25].component;
  ...
  return {
    ...
    p(ctx, dirty) {
      const switch_instance_changes =
        dirty & /*styles, columns, sortedRows*/ 44
          ? get_spread_update(switch_instance_spread_levels, [
              dirty & /*styles*/ 8 && { class: /*styles*/ ctx[3].cell },
              dirty & /*columns*/ 4 &&
                get_spread_object(/*col*/ ctx[25].component.props || {}),
  ...
  return {
    c() {
      ...
      attr(
        td,
        'class',
        (td_class_value = `${/*col*/ ctx[25].class} ${/*styles*/ ctx[3].td}`)
      );
    ...
    p(new_ctx, dirty) {
      ...
      if (
        !current ||
        (dirty & /*columns, styles*/ 12 &&
          td_class_value !==
            (td_class_value = `${/*col*/ ctx[25].class} ${
              /*styles*/ ctx[3].td
            }`))
      ) {
...
// (160:12) {#if col.expandedRowsComponent}
function create_if_block_1(ctx) {
  ...
  return {
    ...
    p(ctx, dirty) {
      const switch_instance_changes = {};
      if (dirty & /*sortedRows*/ 32)
        switch_instance_changes.row = /*row*/ ctx[22];
      if (dirty & /*columns*/ 4) switch_instance_changes.col = /*col*/ ctx[25];

      if (
        switch_value !== (switch_value = /*col*/ ctx[25].expandedRowsComponent)
      ) {
        if (switch_instance) {
          group_outros();
          const old_component = switch_instance;
...
// (159:10) {#each columns as col}
function create_each_block_1(ctx) {
  let if_block_anchor;
  let current;
  let if_block =
    /*col*/ ctx[25].expandedRowsComponent && create_if_block_1(ctx);
  ...
  return {
    ...
    p(new_ctx, dirty) {
      ...
      if (
        !current ||
        (dirty & /*styles*/ 8 &&
          tr_class_value !== (tr_class_value = /*styles*/ ctx[3].tr))
      ) {
...
// (124:6) {#each sortedRows as row, n}
  ...
  return {
    ...
    p(ctx, dirty) {
      if (row_slot) {
        ...
        if (
          row_slot_or_fallback &&
          row_slot_or_fallback.p &&
          dirty & /*columns, sortedRows, styles*/ 44
        ) {
  ...
  return {
    ...
    p(ctx, [dirty]) {
      ...
      if (header_slot) {
        if (
          header_slot.p &&
          (!current || dirty & /*$$scope, sortOrder, sortBy*/ 2051)
        ) {
          update_slot(
            header_slot,
            header_slot_template,
        ...
        if (
          header_slot_or_fallback &&
          header_slot_or_fallback.p &&
          dirty & /*columns, styles, activeModal, sortOrder, sortBy*/ 31
        ) {
      ...
      if (
        !current ||
        (dirty & /*styles*/ 8 &&
          thead_class_value !== (thead_class_value = /*styles*/ ctx[3].thead))
      ) {
      ...
      if (
        !current ||
        (dirty & /*styles*/ 8 &&
          tbody_class_value !== (tbody_class_value = /*styles*/ ctx[3].tbody))
      ) {
      ...
      if (
        !current ||
        (dirty & /*styles*/ 8 &&
          table_class_value !== (table_class_value = /*styles*/ ctx[3].table))
      ) {
...
function instance($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$props) => {
    ...
    if ('sortOrder' in $$props)
      $$invalidate(1, (sortOrder = $$props.sortOrder));
