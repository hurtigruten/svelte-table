...
function add_css() {
	...
	style.id = "svelte-u2gknh-style";
	style.textContent = ".svelte-u2gknh,.svelte-u2gknh::after,.svelte-u2gknh::before{border-spacing:0;border-collapse:collapse}";
		...
		p(ctx, dirty) {
			if (head_slot) {
				if (head_slot.p && (!current || dirty[0] & /*$$scope, columns, hoverColumn, lastSortedKey, sortDescending, isSortable*/ 67137856)) {
					update_slot(head_slot, head_slot_template, ctx, /*$$scope*/ ctx[26], dirty, get_head_slot_changes, get_head_slot_context);
				}
			}
		},
		i(local) {
		...
		p(ctx, dirty) {
			if (empty_slot) {
				if (empty_slot.p && (!current || dirty[0] & /*$$scope*/ 67108864)) {
					update_slot(empty_slot, empty_slot_template, ctx, /*$$scope*/ ctx[26], dirty, get_empty_slot_changes, get_empty_slot_context);
				}
			}
		},
		i(local) {
		...
		p(ctx, dirty) {
			if (cell_slot) {
				if (cell_slot.p && (!current || dirty[0] & /*$$scope, filteredRows, columns, hoverRow, hoverColumn*/ 67159104)) {
					update_slot(cell_slot, cell_slot_template, ctx, /*$$scope*/ ctx[26], dirty, get_cell_slot_changes, get_cell_slot_context);
				}
			}
		},
		i(local) {
		...
		p(ctx, dirty) {
			if (expanded_slot) {
				if (expanded_slot.p && (!current || dirty[0] & /*$$scope, classes, filteredRows*/ 67110016)) {
					update_slot(expanded_slot, expanded_slot_template, ctx, /*$$scope*/ ctx[26], dirty, get_expanded_slot_changes, get_expanded_slot_context);
				}
			}
		},
		i(local) {
...
class SvelteTable extends SvelteComponent {
	constructor(options) {
		super();
		if (!document.getElementById("svelte-u2gknh-style")) add_css();
