(function (global, factory) {
    ...
    const get_sortIcon_slot_changes = dirty => ({});
    const get_sortIcon_slot_context = ctx => ({});
    ...
    // (96:12) {#if col.sortable}
    function create_if_block_4(ctx) {
    	let current;
    	const sortIcon_slot_template = /*#slots*/ ctx[12].sortIcon;
    	const sortIcon_slot = create_slot(sortIcon_slot_template, ctx, /*$$scope*/ ctx[11], get_sortIcon_slot_context);
    	const sortIcon_slot_or_fallback = sortIcon_slot || fallback_block_2(ctx);

    	return {
    		c() {
    			if (sortIcon_slot_or_fallback) sortIcon_slot_or_fallback.c();
    		},
    		m(target, anchor) {
    			if (sortIcon_slot_or_fallback) {
    				sortIcon_slot_or_fallback.m(target, anchor);
    			}
    		...
    		p(ctx, dirty) {
    			if (sortIcon_slot) {
    				if (sortIcon_slot.p && (!current || dirty & /*$$scope*/ 2048)) {
    					update_slot(sortIcon_slot, sortIcon_slot_template, ctx, /*$$scope*/ ctx[11], dirty, get_sortIcon_slot_changes, get_sortIcon_slot_context);
    				}
    			} else {
    				if (sortIcon_slot_or_fallback && sortIcon_slot_or_fallback.p && dirty & /*sortOrder*/ 2) {
    					sortIcon_slot_or_fallback.p(ctx, dirty);
    				}
    			}
    		},
    		i(local) {
    			if (current) return;
    			transition_in(sortIcon_slot_or_fallback, local);
    			current = true;
    		},
    		o(local) {
    			transition_out(sortIcon_slot_or_fallback, local);
    			current = false;
    		},
    		d(detaching) {
    			if (sortIcon_slot_or_fallback) sortIcon_slot_or_fallback.d(detaching);
    		}
    	};
    }
    ...
    function fallback_block_2(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(path0, "d", "M73.092,164.452h255.813c4.949,0,9.233-1.807,12.848-5.424c3.613-3.616,5.427-7.898,5.427-12.847 c0-4.949-1.813-9.229-5.427-12.85L213.846,5.424C210.232,1.812,205.951,0,200.999,0s-9.233,1.812-12.85,5.424L60.242,133.331 c-3.617,3.617-5.424,7.901-5.424,12.85c0,4.948,1.807,9.231,5.424,12.847C63.863,162.645,68.144,164.452,73.092,164.452z");

    			attr(path0, "fill", path0_fill_value = /*sortOrder*/ ctx[1] === 1
    			? "currentColor"
    			: "lightGray");
    			...
    			attr(path1, "fill", path1_fill_value = /*sortOrder*/ ctx[1] === 1
    			? "currentColor"
    			: "lightGray");
    			...
    			attr(svg, "x", "0");
    			attr(svg, "y", "0");
    			attr(svg, "width", "401.998px");
    			attr(svg, "height", "401.998px");
    			attr(svg, "viewBox", "0 0 401.998 401.998");
    			set_style(svg, "enable-background", "new 0 0 401.998 401.998");
    		...
    		p(ctx, dirty) {
    			if (dirty & /*sortOrder*/ 2 && path0_fill_value !== (path0_fill_value = /*sortOrder*/ ctx[1] === 1
    			? "currentColor"
    			: "lightGray")) {
    				attr(path0, "fill", path0_fill_value);
    			}

    			if (dirty & /*sortOrder*/ 2 && path1_fill_value !== (path1_fill_value = /*sortOrder*/ ctx[1] === 1
    			? "currentColor"
    			: "lightGray")) {
    ...
    function create_if_block_3(ctx) {
    	...
    	return {
    		c() {
    			...
    			button.innerHTML = `<span class="sr-only">Show tooltip</span>`;
    ...
    function fallback_block_1(ctx) {
    	...
    	return {
    		...
    		p(ctx, dirty) {
    			if (dirty & /*styles, columns, handleClickCol, undefined, activeModal, sortOrder, $$scope*/ 2206) {
    	...
    	return {
    		...
    		p(ctx, dirty) {
    			...
    			? get_spread_update(switch_instance_spread_levels, [
    					...
    					dirty & /*columns*/ 4 && get_spread_object(/*col*/ ctx[25].renderComponent.props || {}),
    ...
    // (142:6) {#each sortedRows as row, n}
    ...
    function create_fragment(ctx) {
    	...
    	let current;
    	let if_block0 = /*activeModal*/ ctx[4] && create_if_block_5(ctx);
    	...
    	return {
    		...
    		p(ctx, [dirty]) {
    			...
    			if (header_slot) {
    				...
    				if (header_slot_or_fallback && header_slot_or_fallback.p && dirty & /*columns, styles, activeModal, sortOrder, $$scope*/ 2078) {
