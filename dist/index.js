(function (global, factory) {
      ...
      m(target, anchor) {
        ...
        if (!mounted) {
          dispose = listen(th, 'click', function () {
            if (
              is_function(
                /*col*/ ctx[25].sortable ? click_handler_1 : undefined
              )
            )
  ...
  function create_if_block_1(ctx) {
    ...
    return {
      ...
      p(ctx, dirty) {
        ...
        if (dirty & /*columns*/ 4)
          switch_instance_changes.col = /*col*/ ctx[25];

        if (
          switch_value !==
          (switch_value = /*col*/ ctx[25].expandedRowsComponent)
        ) {
          if (switch_instance) {
            group_outros();
            const old_component = switch_instance;
    ...
    return {
      ...
      p(ctx, dirty) {
        if (row_slot) {
          if (
            row_slot.p &&
            (!current || dirty & /*$$scope, sortedRows*/ 2080)
          ) {
            update_slot(
              row_slot,
              row_slot_template,
  ...
  function instance($$self, $$props, $$invalidate) {
    ...
    const click_handler = (col) =>
      $$invalidate(4, (activeModal = col.helpModal));
